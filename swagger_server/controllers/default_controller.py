...
def list_students(last_name=None):  # noqa: E501
    """List all students

    queries students # noqa: E501

    :param last_name: part of last name of students to return
    :type last_name: str

    :rtype: Student
    """
    res = student_service.list_students(last_name)
    if res:
        return res
    return 'Not Found', 404
